...
class MyApp:
    ...
    def __init__(self, parent):
        ...
        self.ButtonContainer = Frame(self.TopContainer, padx = 20, bg ='grey')
        ...
        self.Decode = Button(self.ButtonContainer, text = "Decode", width = 7)
    ...
    def DebugClick(self):
        ...
        self.Decoder.insert(END,"director : "+str(director))
        ...
        self.Decoder.insert(END,"\nfin : "+fin)
        self.Decoder.insert(END,"\nss : "+str(ss))
        self.Decoder.insert(END,"\n-----------------------------------\n" + (self.Input.index(INSERT)).split(".")[0] + "줄의 " + (self.Input.index(INSERT)).split(".")[1] + "번째 문자 처리..")
